...
export class InwardRemmitanceComponent implements OnInit {
    ...
    if (!data.completed) {
      ...
      if (this.purposeCode == 'P0103') {
        if (this.myRadio == 'axisBank') {
          this.router.navigate(['home/inward-remmitance-p0103', { sbno: data.pi_poNo, file: data.file, detail: this.detail }]);
        }
      ...
      if (this.purposeCode == 'P0103') {
        if (this.myRadio == 'axisBank') {
          this.router.navigate(['home/request-letter', { sbno: data.sbno, file: data.file, detail: this.detail }]);
        }
        else if (this.myRadio == 'yesBank') {
          this.router.navigate(['home/request-letter', { sbno: data.sbno, file: data.file, detail: this.detail }]);
        }
  ...
  showThisPdf(sbno) {
    ...
    if (this.purposeCode == "P0102") {
      if (this.myRadio == 'axisBank') {
        this.router.navigate(['home/request-letter', { sbno: sbno, file: this.purposeCode, detail: this.detail }]);
      }
      else if (this.myRadio == 'yesBank') {
        this.router.navigate(['home/request-letter', { sbno: sbno, file: this.purposeCode, detail: this.detail }]);
      }
      ...
      if (this.myRadio == 'axisBank') {
        this.router.navigate(['home/inward-remmitance-p0103', { sbno: sbno, file: this.purposeCode, detail: this.detail }]);
      }
      else if (this.myRadio == 'yesBank') {
        this.router.navigate(['home/inward-remmitance-p0103', { sbno: sbno, file: this.purposeCode, detail: this.detail }]);
      }
